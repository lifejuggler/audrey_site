...
namespace Concrete\Package\ImageBanner\Block\ImageBanner;
...
class Controller extends BlockController
{
    ...
    protected $btTable = 'btContentImageBanner';
    ...
    {
        return t("Adds image banner and onstates from the library to pages.");
    }
    ...
    public function view()
    {
        ...
        $this->set('caption', $this->getCaption());
