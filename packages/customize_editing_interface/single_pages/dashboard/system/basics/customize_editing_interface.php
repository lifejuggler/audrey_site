...
<!--
Example:
<form method="post" id="site-form" action="http://localhost/concrete5/index.php/dashboard/system/basics/customize_editing_interface/reset">
-->
        ...
        ?>
            ...
            <div id="ccm-tab-content-basic-options" class="ccm-tab-content">
                ...
                <div class="form-group">
                    ...
                    <?php  echo $form->select('presets', array(0 => t('No Preset'), 'enhanced_preset' => t('5.7 Enhanced'), 'retro' => t('5.6 Retro')), $presets, array('style' => 'width: 150px;')); ?>
                </div>

                <div class="preset-visibility">

                    <!-- Add Content Block Icons Per Row -->
                    <label><?php  echo t('Add Content Block Icons Per Row'); ?></label>
                    <br>
                    ...
                    <div class="form-group">
                        ...
                        <?php  echo $form->checkbox('showAreaNames', $showAreaNames, $showAreaNames ? 'checked' : ''); ?>
                    </div>

                    <!-- Always Show Block Outlines -->
                    <div class="form-group">
                        <?php  echo $form->label('showBlockOutlines', t('Always show block outlines while in edit mode')); ?>
                        <?php  echo $form->checkbox('showBlockOutlines', $showBlockOutlines, $showBlockOutlines ? 'checked' : ''); ?>
                    </div>

                    <!-- Always Show Area Outlines -->
                    <div class="form-group">
                        <?php  echo $form->label('showAreaOutlines', t('Always show area outlines while in edit mode')); ?>
                        <?php  echo $form->checkbox('showAreaOutlines', $showAreaOutlines, $showAreaOutlines ? 'checked' : ''); ?>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <?php  echo $form->checkbox('showBlockBackgroundHoverColor', $showBlockBackgroundHoverColor, $showBlockBackgroundHoverColor ? 'checked' : ''); ?>
                    </div>

                    <!-- WCAG 2.0 Compliant Color Contrast -->
                    <div class="form-group">
                        <?php  echo $form->label('wcag2Compliant', t('WCAG 2.0 compliant color contrast')); ?>
                        <?php  echo $form->checkbox('wcag2Compliant', $wcag2Compliant, $wcag2Compliant ? 'checked' : ''); ?>
                    </div>
